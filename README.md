...
Today it is 78 cases over three schemas, asserting **every one** of the spec's 20 error codes,
...
from Rust, Python, Node and WebAssembly against the same 78 cases, in CI, on three operating
systems.
